...
local name_log = user_print_name(msg.from)
	...
	if matches[1] == 'help' and msg.to.type == 'user' or matches[1] == 'pmhelp' and is_admin1(msg) and msg.to.type ~= 'user' then
		...
		text = "Welcome to Robot!\n\nThis is a bot run by @aryaxbow for managing the official group @xbow09 on Telegram\n\nCheck out our channel @xbow09\n\nAlso join To Group Support\n\nhttps://telegram.me/joinchat/BX_uAAp6uxrAxeJ9JEJG-A for knowing more!"
     	return text
    end
